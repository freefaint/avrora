...
export const RegistryPaginationSettingsContext = createContext<RegsitryPaginationSettingsContextBody>({
  count: 10,
  variants: [],
});
...
export const usePagination = ({
  count,
  variants,
}: RegsitryPaginationSettingsContextBody): RegistryPaginationContextBody => {
  const [paginationContext, setPaginationContext] = useState<RegistryPaginationInputContextBody>({
    ...DEFAULT_REGISTRY_PAGINATION_CONTEXT,
    limit: count,
  });
